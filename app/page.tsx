...
export default function Home() {
  ...
  const planningFingerprint = useMemo(() => planningInputFingerprint(scheduleWeek, recipeItems), [recipeItems, scheduleWeek]);
  const generatedWeek = useMemo(() => generateSmartPlan(scheduleWeek, recipeItems, inventory, mealCompletions), [inventory, mealCompletions, recipeItems, scheduleWeek]);
  const week = useMemo(() => {
  ...
  return <main className="app-shell">
    ...
    <section className="content">
      ...
      {active === 'Groceries' && <GroceriesView items={displayItems} week={week} store={store} setStore={setStore} toggle={toggleItem} costcoThisWeek={costcoThisWeek} setCostcoThisWeek={changeCostcoWeek} />}
    </section>
