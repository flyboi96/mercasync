...
function WeeklyCheck({ inventory, week, trips, dinnerTarget, setDinnerTarget, goals, setGoals, householdId, costcoThisWeek, setCostcoThisWeek, aiDraft, approveWeek, editRoutines, editMeal, viewRecipe, open }: any) {
